...
play what has already been rendered, and to manage who else may. The rendering
still happens on the local GPU, so the player answers only while that machine is
on.
